...
Um sistema desktop de controle de entrada e saída de pessoas, desenvolvido para a Itallian Hairtech, que gerencia registros de funcionários, visitantes e seus veículos.
...
│   |   \__ excel.js            # Geração de relatórios
│   |-- resources/data/
│       \__ data.db             # Banco de dados SQLite
```
...
- Node.js 16+ 
- 1000MB de espaço em disco

## Autor

Desenvolvido por **Guilherme Tomaz** para **Itallian Hairtech**